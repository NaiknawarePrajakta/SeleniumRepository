...
public class CoverFoxTC2UsingPropertiseFile
{
	WebDriver driver;
	...
	public void launchBrowser()
	{
		...
		filePath = "C:\\Users\\lenovo\\eclipse-workspace\\March23_Selenium\\fbTest.properties";
	...
	public void preConditions() throws InterruptedException, EncryptedDocumentException, IOException
	{
		...
		Thread.sleep(1000);
		memberDetailsPage.handleAgeDropDown(Utility.readDataFromPropertiseFile("age"));
		memberDetailsPage.clickOnNextButton();
		Thread.sleep(1000);
		addressDertailsPage.enterPincode(Utility.readDataFromPropertiseFile("pincode"));
		addressDertailsPage.enterMobileNumber(Utility.readDataFromPropertiseFile("mobNum"));
